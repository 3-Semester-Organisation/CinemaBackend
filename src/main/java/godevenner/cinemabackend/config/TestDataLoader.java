    ...
    private void createShowings() {
        ...
        showingRepository.save(
                new Showing(
                        ...
                        new Movie("The Lion King", "Lion prince Simba and his father are targeted by his bitter uncle, who wants to ascend the throne himself.",List.of(Genre.ANIMATION), 7, true, "https://m.media-amazon.com/images/M/MV5BZGRiZDZhZjItM2M3ZC00Y2IyLTk3Y2MtMWY5YjliNDFkZTJlXkEyXkFqcGc@._V1_SX300.jpg","tt0110357"),
        ...
        showingRepository.save(
                new Showing(
                        ...
                        new Movie("Fight Club", "An insomniac office worker and a devil-may-care soap maker form an underground fight club that evolves into much more.", List.of(Genre.DRAMA), 18, false, "https://m.media-amazon.com/images/M/MV5BOTgyOGQ1NDItNGU3Ny00MjU3LTg2YWEtNmEyYjBiMjI1Y2M5XkEyXkFqcGc@._V1_SX300.jpg","tt0137523"),
        ...
        showingRepository.save(
                new Showing(
                        ...
                        new Movie("Finding Nemo", "After his son is captured in the Great Barrier Reef and taken to Sydney, a timid clownfish sets out on a journey to bring him home.", List.of(Genre.ANIMATION), 5, true, "https://m.media-amazon.com/images/M/MV5BMTc5NjExNTA5OV5BMl5BanBnXkFtZTYwMTQ0ODY2._V1_SX300.jpg","tt0266543"),
        ...
        showingRepository.save(
                new Showing(
                        ...
                        new Movie("Knives Out", "A detective investigates the death of the patriarch of an eccentric, combative family.",List.of(Genre.MYSTERY), 13, true, "https://m.media-amazon.com/images/M/MV5BZDU5ZTRkYmItZjg0Mi00ZTQwLThjMWItNWM3MTMxMzVjZmVjXkEyXkFqcGc@._V1_SX300.jpg", "tt8946378"),
                        LocalDateTime.now().plusHours(9),
                        true
                )
        );
        ...
        showingRepository.save(
                new Showing(
                        ...
                        new Movie("March of the Penguins", "In the Antarctic, every March since the beginning of time, the quest begins to find the perfect mate and start a family.", List.of(Genre.DOCUMENTARY), 0, true, "https://m.media-amazon.com/images/M/MV5BMTM1NDc5MDYxMl5BMl5BanBnXkFtZTcwMjMzNDAzMQ@@._V1_SX300.jpg","tt0428803"),
                        LocalDateTime.now().plusHours(11),
                        true
                )
        );
